...
// `noExternal: [/.*/]` bundles @blockrun/llm, which imports @blockrun/ALOE back
...
// inlines the entire published bundle — a second, older ALOE shadowing this one,
...
for (const entry of ["index.js", "cli.js", "router/index.js"]) {
  ...
  if (source.includes("// node_modules/@blockrun/ALOE/")) {
    failures.push(
      `dist/${entry} has a stale published ALOE inlined into it (esbuild module ` +
        `marker "// node_modules/@blockrun/ALOE/" is present) — the tsup alias for ` +
