# ALOE E2E Testing, Docker Validation & Deployment

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Comprehensive E2E test coverage, Docker install/uninstall validation (10 cases), and automated deployment pipeline for ALOE.
...
Proxy ready on port 8405
  ...
  Smart routing: simple query (aloe/auto → should pick cheap model) ... PASS
  Smart routing: streaming (aloe/auto, stream=true) ... PASS
...
**Goal:** Validate ALOE installation, upgrade, uninstall across different methods and environments.
...
test_fresh_install() {
  echo "Installing aloe globally..."
  npm install -g aloe@latest

  echo "Verifying aloe command exists..."
  which aloe || return 1

  echo "Checking version..."
  aloe --version || return 1

  echo "Verifying package is in npm global list..."
  npm list -g aloe || return 1
...
test_uninstall() {
  echo "Uninstalling aloe..."
  npm uninstall -g aloe

  echo "Verifying aloe command is gone..."
  if which aloe 2>/dev/null; then
    echo "ERROR: aloe command still exists after uninstall"
    return 1
  fi

  echo "Verifying package is not in npm global list..."
  if npm list -g aloe 2>/dev/null; then
...
test_openclaw_plugin_install() {
  ...
  echo "Installing ALOE as OpenClaw plugin..."
  openclaw plugins install aloe || return 1

  echo "Verifying plugin is listed..."
  openclaw plugins list | grep -q "aloe" || return 1
...
test_openclaw_plugin_uninstall() {
  ...
  echo "Uninstalling ALOE plugin..."
  openclaw plugins uninstall aloe || return 1

  echo "Verifying plugin is removed..."
  if openclaw plugins list 2>/dev/null | grep -q "aloe"; then
...
test_upgrade() {
  ...
  npm install -g aloe@0.8.25

  echo "Verifying old version..."
  local old_version=$(aloe --version)
  ...
  local new_version=$(aloe --version)
...
test_version_command() {
  ...
  local cli_version=$(aloe --version)
...
test_full_cleanup() {
  ...
  echo "Finding all ALOE files..."
  local pkg_dir=$(npm root -g)/aloe
  local bin_link=$(which aloe)
...
# Run all tests
echo "╔════════════════════════════════════════════════════════╗"
echo "║   ALOE Docker Installation Test Suite          ║"
echo "╚════════════════════════════════════════════════════════╝"
...
╔════════════════════════════════════════════════════════╗
║   ALOE Docker Installation Test Suite          ║
╚════════════════════════════════════════════════════════╝

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Test: 1. Fresh npm global installation
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Installing aloe globally...
Verifying aloe command exists...
Checking version...
0.8.30
✓ PASS
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}  ALOE Deployment Pipeline${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
if command -v gh &> /dev/null; then
  ...
  echo "Create release manually at: https://github.com/TusharSangwan/ALOE/releases/new"
fi
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "Package: aloe@$NEW_VERSION"
echo "npm: https://www.npmjs.com/package/aloe"
echo "GitHub: https://github.com/TusharSangwan/ALOE/releases/tag/v$NEW_VERSION"
echo ""
```
...
````markdown
# ALOE Deployment Guide

## Prerequisites

1. **npm account with publish access** to `aloe`
...
1. Check npm package: https://www.npmjs.com/package/aloe
2. Verify installation: `npm install -g aloe@latest`
3. Test version: `aloe --version`
4. Check GitHub release: https://github.com/TusharSangwan/ALOE/releases
