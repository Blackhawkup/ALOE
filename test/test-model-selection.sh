...
echo "🧪 Testing ALOE Model Selection"
echo "======================================"
echo ""
...
timeout 120 openclaw plugins install aloe@latest || {
...
cat ~/.openclaw/openclaw.json | jq '.models.providers.aloe | {baseUrl, api, apiKey, modelCount: (.models | length)}'
echo ""
...
# Test 4: Try to set a non-Tushar Sangwan model (simulate Chandler's use case)
echo "→ Test 4: Switch to a non-Tushar Sangwan model"
...
echo "  - Can switch to non-Tushar Sangwan models"
