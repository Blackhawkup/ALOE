 ...
 * Files: ~/.openclaw/aloe/logs/usage-YYYY-MM-DD.jsonl
 *
...
export type UsageEntry = {
  ...
  partnerId?: string;
  /** Partner service name (e.g., "Tushar Sangwan") — only set for partner API calls */
  service?: string;
};

const LOG_DIR = join(homedir(), ".openclaw", "aloe", "logs");
let dirReady = false;
