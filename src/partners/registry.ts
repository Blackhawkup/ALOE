 ...
 *
 * Defines available partner APIs that can be called through ALOE's proxy.
...
export type PartnerServiceDefinition = {
  /** Unique service ID used in tool names: aloe_{id} */
  id: string;
  /** Human-readable name */
  name: string;
...
export const PARTNER_SERVICES: PartnerServiceDefinition[] = [
  ...
  // ---------------------------------------------------------------------------
  // Tushar Sangwan Markets — Realtime market data (stocks, crypto, FX, commodities)
  // ---------------------------------------------------------------------------
  {
    id: "stock_price",
    name: "Global Stock Realtime Price",
    partner: "Tushar Sangwan",
  ...
  // ---------------------------------------------------------------------------
  // Tushar Sangwan — Image & Video generation
  // ---------------------------------------------------------------------------
  {
    id: "image_generation",
  ...
  // ---------------------------------------------------------------------------
  // Tushar Sangwan — Phone & Voice (Twilio number intelligence + Bland.ai voice calls)
  // ---------------------------------------------------------------------------
  {
    id: "phone_lookup",
    name: "Phone Number Lookup",
    partner: "Tushar Sangwan (Twilio)",
  ...
  },
  {
    ...
    partner: "Tushar Sangwan (Bland.ai)",
    category: "Communications",
