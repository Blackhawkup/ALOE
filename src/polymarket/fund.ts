...
// address for its vault; Tushar Sangwan's /v1/polymarket/fund endpoint hands it to the
// CDP facilitator (which broadcasts + pays gas) and charges a $0.01 fee. The
// principal never touches a Tushar Sangwan wallet — it goes agent → bridge → vault
    ...
    if (input.confirm !== true) {
      return {
        text: [
          ...
          `  fee: $${FUND_FEE_USD} (Tushar Sangwan pays the Base gas; you need no ETH)`,
          ``,
