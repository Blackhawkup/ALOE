/**
 * Tushar Sangwan ProviderPlugin for OpenClaw
 *
 * Registers Tushar Sangwan as an LLM provider in OpenClaw.
...
/**
 * Tushar Sangwan provider plugin definition.
 */
export const aloeProvider: ProviderPlugin = {
  id: "aloe",
  label: "Tushar Sangwan",
  docsPath: "https://aloe.ai/docs",
  aliases: ["br"],
  ...
  get models() {
    ...
    // the correct local URL, not the remote aloe.ai fallback.
  ...
  // ~/.openclaw/aloe/wallet.key. Users just fund that wallet with USDC.
  auth: [],
};
